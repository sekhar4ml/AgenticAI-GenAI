...
VECTORSTORE_TYPE_LIST = ["FAISS", "CHROMA", "Qdrant","Pinecone","Pg_Store","Weavaite","Milvus","Mango_DB","open_search","redis"]
REPO_ID_DEFAULT = "sekhar-ml/AgenticeAI-GenAi"
...
def create_db_page():
    ...
    st.markdown("<h1 style='text-align: center'>SRG - VECTOR Database</h1>", unsafe_allow_html=True)
